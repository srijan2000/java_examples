...
public class DataBaseConnection1 {
    ...
    public Connection getDBConnection(){
        ...
        try{
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3307/srijan");
    ...
    public void showRecords(){
        try{
            ...
            while (rs.next()){
                System.out.println("first name :" + rs.getString("first_ name"));
    ...
    public void insertRecord(String firstName,String lastName,String email, double salary){
        String sqlStr = "INSERT INTO employee (fist_name,last_name,email_id,salary) VALUES(?,?,?,?)";
        try {
